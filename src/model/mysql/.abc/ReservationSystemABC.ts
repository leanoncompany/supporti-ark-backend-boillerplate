...
import ProductABC from './ProductABC';

export default class ReservationSystemABC extends ProductABC {
	@AllowNull(false)
	@Column({
		type: DataType.TEXT(),
		comment: '요일별 가능한 시간대 {"MONDAY": ["09:00-18:00"], "TUESDAY": [], "WEDNESDAY": ["9:00-18:00"]}',
	})
